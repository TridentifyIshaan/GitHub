...
Ishaan Rastogi ( currently studying in Amity University, Noida )
Shivangi ( currently studying in Vellore Institute of Technology, Vellore)
Vansh Bindal ( currently studying in Maharaja Agrasen Institute of Technology, Delhi )
of school D.A.V Sreshtha Vihar
'''

#importing CurrencyRates module from forex_python converter
...
def intro():
    ...
    print("◀\t\t\t\t   •——————•°•✧•°•——————•                                 ")
    print("◀                                                                                         ")
    print("◀\t\t\t                MADE BY : Ishaan, Shivangi and Vansh")
    print("◀                                                                                         ")
    print("◀\t\t\t\t   •——————•°•✧•°•——————•                                 ")
    print("◀                                                                                         ")
    print("◀\t\t\t  SCHOOL : DAV PUBLIC SCHOOL, SRESHTHA VIHAR, DELHI-92")
    print("◀                                                                                         ")
    print("◀\t\t\t\t   •——————•°•✧•°•——————•                                 ")
    print("◀                                                                                         ")
    print("◀\t\t\t        Welcome to New National Bank (NNB) User Database!")
    print("◀                                                                                         ")
    print("◀\t\t\t\t      ࿐. *. ⋆---------•»--•--«•---------•°. *࿐                        ")
    print("◀                                                                                         ")
    print("◀\t\t\t        Welcome to New National Bank (NNB) Notice Board!")
    print("◀                                                                                         ")
    print("◀\t\t\t\t WARNING NOTE!:")
    print("◀                                                                                         ")
...
#function to exchange foreign currency
def currency():
    cr= CurrencyRates()
    print("NOTE: Currently able to convert USD to INR and vice versa")
    amount= int(input("Enter the amount you want to convert :"))
    from_currency= input("Pls enter the currency code that the amount has to be converted from :").upper()
    to_currency= input("Pls enter the currecy code to convert the amount to :").upper()
...
while ch =='y':
    ...
    print('\t11. FOREIGN CURRENCY EXCHANGE')
    print("\t12. EXIT")
    print("\tSelect Your Option (1-12) ")
    ch = input('\nEnter the choice:')
...
# CALLING OF FUNCTIONS TO MAKE THE PROJECT WORK!
    ...
    #Bank Notice Board
        ...
        print("◀\t\t\t\t   •——————•°•✧•°•——————•                                 ")
        print("◀                                                                                         ")
        print("◀\t        You are biding a farewell to New National Bank (NNB) User Database but don't forget us!")
        print("◀                                                                                         ")
        print("◀\t\t\t\t      ࿐. *. ⋆---------•»--•--«•---------•°. *࿐                        ")
        print("◀                                                                                         ")
        print("◀\t\t\t        Welcome to New National Bank (NNB) Notice Board!")
